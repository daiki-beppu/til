...
コンピューターの処理は2進数で行われます。
理由：電気回路のON/OFF（1/0）で表現できるため。
...
```
例（右から左へ）：
10進数: 1(10^0), 10(10^1), 100(10^2), 1000(10^3)
2進数:  1(2^0),  2(2^1),   4(2^2),    8(2^3),
16進数: 1(16^0), 16(16^1), 256(16^2), 4,096(16^3)
```

桁の重みが増える際の乗数となる数を基数といいます。
例えば、10進数の基数は10、2進数の基数は2、16進数の基数は16です。
