...
- [目的 1 : 影の追加](#目的-1--影の追加)
  - [影を映す壁を追加](#影を映す壁を追加)
  - [影の投影と描画を有効にする](#影の投影と描画を有効にする)
  - [ヘルパーを使って影の最適化](#ヘルパーを使って影の最適化)
- [目的 2 : デバック UI で ヘルパーの表示切替](#目的-2--デバック-ui-で-ヘルパーの表示切替)
- [目的 3 : デバック UI をデフォルトで非表示にする](#目的-3--デバック-ui-をデフォルトで非表示にする)
